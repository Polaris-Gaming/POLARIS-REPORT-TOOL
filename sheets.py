...
def get_spreadsheet():
    ...
    if not sheet_id:
        raise Exception("GOOGLE_SHEET_ID is missing from .env")
...
def append_report(reporter, team_number, map_number, map_name, p1_kills, p2_kills, p3_kills, p4_kills, placement):
    team = get_team(team_number)
    ...
    reports_sheet.append_row(row_to_append, value_input_option="USER_ENTERED")
